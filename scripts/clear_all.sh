...
TARGET_DIR=$TARGET_CSS_DIR $SCRIPTS/clear_css.sh
...
TARGET_DIR=$TARGET_IMG_DIR $SCRIPTS/clear_img.sh
...
TARGET_DIR=$TARGET_HTML_DIR $SCRIPTS/clear_html.sh
...
TARGET_DIR=$TARGET_JS_DIR $SCRIPTS/clear_js.sh