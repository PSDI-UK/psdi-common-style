...
$(document).ready(function () {
  ...
  if (loadHeader) {
    $("#psdi-header").load("https://psdi-uk.github.io/psdi-common-style/psdi-common-header.html",
      function (_response, status, _xhr) {
        if (status != "error") {
  ...
  if (loadFooter) {
    $("#psdi-footer").load("https://psdi-uk.github.io/psdi-common-style/psdi-common-footer.html",
      function (_response, status, _xhr) {
        if (status == "error") {
